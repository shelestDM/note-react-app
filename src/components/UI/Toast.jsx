const Toast = (props) => {
    return (
        <div className="animate-toastAppear absolute left-[calc(50%-150px)] bottom-10 z-[100] bg-teal-500 flex items-center justify-start gap-5 w-[300px] p-4 mb-4 text-gray-500 rounded-lg shadow">
